...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ 
      background: 'radial-gradient(ellipse at top, #3b2f8f 0%, #2a1f5f 25%, #1a0f3f 50%, #0d0520 100%)',
        ...
        <div className="max-w-7xl mx-auto px-8 py-5">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-10">
              ...
              <button onClick={() => scrollToSection('how-it-works')} className="relative text-base font-medium text-gray-300 hover:text-white hover:scale-105 transition-all duration-300 group">
                How it works
                <span className="absolute -bottom-1 left-0 h-0.5 w-0 group-hover:w-full bg-gradient-to-r from-purple-400 to-pink-400 transition-all duration-300"></span>
              </button>
              <button onClick={() => scrollToSection('contact')} className="relative text-base font-medium text-gray-300 hover:text-white hover:scale-105 transition-all duration-300 group">
                Contact
                <span className="absolute -bottom-1 left-0 h-0.5 w-0 group-hover:w-full bg-gradient-to-r from-purple-400 to-pink-400 transition-all duration-300"></span>
              </button>
            </div>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-4 pb-4 space-y-2">
              {[
                ...
                <button key={item.id} onClick={() => scrollToSection(item.id)} className="block w-full text-left px-4 py-3 rounded-xl text-gray-300 hover:bg-purple-600/20 transition-all duration-300">
                  {item.label}
                </button>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { icon: ImageIcon, title: 'Share Photos & Files', description: 'Send images and files effortlessly, right inside the chat.', gradient: 'from-purple-500 to-indigo-600' },
              { icon: MessageCircle, title: 'Clean, Organized Chats', description: 'Messages are neatly grouped by date, so nothing feels messy.', gradient: 'from-indigo-500 to-purple-600' },
