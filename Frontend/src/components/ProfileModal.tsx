        ...
        <div className="p-6">
          ...
          <div className="flex flex-col items-center mb-6">
            <div className="relative group">
              ...
              <button className="absolute bottom-0 right-0 w-8 h-8 bg-gray-800 border-2 border-[#1a1a1a] rounded-full flex items-center justify-center text-white hover:bg-gray-700 transition shadow-lg cursor-pointer">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-[#0a0a0a] border border-gray-800 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
            />
          </div>
