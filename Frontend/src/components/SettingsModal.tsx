      ...
      <div className="bg-[#1a1a1a] rounded-2xl w-full max-w-md border border-gray-800 shadow-2xl">
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <button className="w-full p-3 bg-[#0a0a0a] rounded-xl border border-gray-800 text-left hover:bg-gray-900 transition cursor-pointer">
          ...
          <div>
            ...
            <select className="w-full p-3 bg-[#0a0a0a] border border-gray-800 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer">
